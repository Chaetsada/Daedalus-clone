  ...
  return (
    <main className="pt-[15vh]">
      <header className="flex flex-col gap-5 container px-8 py-10 md:py-20">
        <h1 className="text-5xl md:text-8xl font-heading">PINETREE HOUSE</h1>
        <div className="w-full  h-[300px] md:h-[400px] lg:h-[600px] relative">
          <Image
            className="object-cover"
            src="/static/project-images/pinetree-house/1.webp"
            alt="header-image"
            fill
          />
        </div>
      ...
      <div className="flex flex-col  md:flex-row gap-5 h-fit container px-8 py-10 md:py-20">
        ...
        >
          <Image
            className="object-cover"
            src="/static/project-images/pinetree-house/2.webp"
            alt="pinetree-house-image"
            fill
          />
        </motion.div>
        <motion.div
        ...
        >
          <Image
            className="object-cover"
            src="/static/project-images/pinetree-house/3.webp"
            alt="pinetree-house-image"
            fill
          />
        </motion.div>
      ...
      <div className="flex flex-col  md:flex-row  gap-5 h-fit container px-8 py-10 md:py-20">
        ...
        >
          <Image
            className="object-cover"
            src="/static/project-images/pinetree-house/4.webp"
            alt="pinetree-house-image"
            fill
          />
        </motion.div>
        ...
        >
          <Image
            className="object-cover"
            src="/static/project-images/pinetree-house/5.webp"
            alt="pinetree-house-image"
            fill
          />
        </motion.div>
      ...
      <div className="flex flex-col  md:flex-row  gap-5 h-fit container px-8 py-10 md:py-20">
        ...
        >
          <Image
            className="object-cover"
            src="/static/project-images/pinetree-house/6.webp"
            alt="pinetree-house-image"
            fill
          />
        </motion.div>
        ...
        >
          <Image
            className="object-cover"
            src="/static/project-images/pinetree-house/7.webp"
            alt="pinetree-house-image"
            fill
          />
        </motion.div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between container px-8 py-10 md:py-20">
        <Link href="/projects/opa-penthouse">
        ...
        {/*--- PREVIOUS BUTTON ---*/}
        <Link href="/projects/residence-948">
