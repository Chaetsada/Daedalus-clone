  ...
  return (
    <main className="pt-[15vh]">
      <header className="flex flex-col gap-5 container px-8 py-10 md:py-20">
        <h1 className="text-5xl md:text-8xl font-heading">RESIDENCE 948</h1>
        <div className="w-full  h-[300px] md:h-[400px] lg:h-[600px] relative">
          <Image
            className="object-cover"
            src="/static/project-images/residence-948/1.webp"
            alt="header-image"
            fill
          />
        </div>
      ...
      <div className="flex flex-col  md:flex-row gap-5 h-fit container px-8 py-10 md:py-20">
        ...
        >
          <Image
            className="object-cover"
            src="/static/project-images/residence-948/2.webp"
            alt="residence-948-image"
            fill
          />
        </motion.div>
        <motion.div
        ...
        >
          <Image
            className="object-cover"
            src="/static/project-images/residence-948/3.webp"
            alt="residence-948-image"
            fill
          />
        </motion.div>
      ...
      <div className="flex flex-col  md:flex-row  gap-5 h-fit container px-8 py-10 md:py-20">
        ...
        >
          <Image
            className="object-cover"
            src="/static/project-images/residence-948/4.webp"
            alt="residence-948-image"
            fill
          />
        </motion.div>
        ...
        >
          <Image
            className="object-cover"
            src="/static/project-images/residence-948/5.webp"
            alt="residence-948-image"
            fill
          />
        </motion.div>
      ...
      <div className="flex flex-col  md:flex-row  gap-5 h-fit container px-8 py-10 md:py-20">
        ...
        >
          <Image
            className="object-cover"
            src="/static/project-images/residence-948/6.webp"
            alt="residence-948-image"
            fill
          />
        </motion.div>
        ...
        >
          <Image
            className="object-cover"
            src="/static/project-images/residence-948/7.webp"
            alt="residence-948-image"
            fill
          />
        </motion.div>
      ...
      {/*---------------------------- END PARAGRAPH #3 ---------------------------------*/}
      <div className="flex items-center justify-between container px-8 py-10 md:py-20">
